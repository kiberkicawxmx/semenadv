...
<head>
  ...
  <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/feedback/css/form-processing.css">
</head>
...
<body>
  ...
  <div class="container">
    ...
    <div class="form-container form__wrapper">
      ...
      <form id="feedback-form" action="<?php echo get_template_directory_uri(); ?>/feedback/form-processing.php" enctype="multipart/form-data" novalidate>
        <div class="form-row">
          <!-- Имя пользователя -->
        ...
        <div class="form-group form-captcha">
          <img class="form-captcha__image" src="<?php echo get_template_directory_uri(); ?>/feedback/captcha/captcha.php" data-src="<?php echo get_template_directory_uri(); ?>/feedback/captcha/captcha.php"
  ...
  <script src="<?php echo get_template_directory_uri(); ?>/feedback/js/form-processing.js"></script>
  <script>
    /*
      attachMaxItems: 3,
